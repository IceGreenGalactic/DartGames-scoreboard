...
const texts = {
  en: {
    title: "501 Rules",
    intro: "Start at 501. Three darts per turn.",
    sections: [
      {
        h: "How to Start",
      ...
      {
        h: "Scoring",
        p: "Subtract from 501. Singles=face value, doubles×2, triples×3. Bull 25, double bull 50.",
      },
      {
        h: "Winning",
  ...
  no: {
    title: "501 Regler",
    intro: "Start på 501. Tre piler per runde.",
    sections: [
      {
        h: "Start",
      ...
      {
        h: "Scoring",
        p: "Trekk fra 501. Single=verdi, dobbel×2, trippel×3. Bull 25, dobbel bull 50.",
      },
      {
        h: "Vinne",
